		...
		if (factoryMethodToUse == null || argsToUse == null) {
			...
			for (Method candidate : candidates) {
				...
				if (paramTypes.length >= minNrOfArgs) {
					...
					// 如果具有相同参数数量的方法具有相同的类型差异权重，则收集此类型选项，将方法添加到ambiguousFactoryMethods集合中，
					// 在下方会检测ambiguousFactoryMethods是否为空，如果不为空，则抛出异常
